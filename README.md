...
Get binaries from the build server [![](https://github.com/boomboompower/de4dot/workflows/GitHub%20CI/badge.svg)](https://github.com/boomboompower/de4dot/actions).
